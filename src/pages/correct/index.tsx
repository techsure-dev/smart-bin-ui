...
const CorrectPage = () => {
  ...
  useEffect(() => {
    ...
    let newItem: any[] = [];
    if (state.item_th) newItem = [state];
    else if (Array.isArray(state.result)) newItem = state.result;
  ...
  // Animations for checkmark and text
  useEffect(() => {
  ...
  return (
    <Flex className="w-screen h-screen items-center justify-center relative bg-white overflow-hidden">
      ...
      {showText && (
        <Flex className="absolute w-full h-screen flex flex-col items-center justify-start z-10 bg-white">
          ...
          >
            ...
            <Flex vertical className="mt-56 gap-24">
              ...
              >
                <Flex vertical>
                  <Text className="text-heading-s text-text-brand">
                    ทิ้งขยะเพิ่มเติม
                  </Text>
                  <Text className="text-sub-heading-xs text-text-brand">
                    (More trash to sort)
                  </Text>
                </Flex>
              </Button>
              ...
              >
                <Flex vertical>
                  <Text className="text-heading-s text-text-light">
                    ทิ้งขยะครบหมดแล้ว
                  </Text>
                  <Text className="text-sub-heading-xs text-text-light">
                    (All done)
                  </Text>
                </Flex>
              </Button>
