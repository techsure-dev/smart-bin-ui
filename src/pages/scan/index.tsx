...
const ScanPage = () => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute rounded-3xl overflow-hidden flex items-center justify-center z-30 border-[14px] border-[#AF6214] bg-white">
        <video
            ref={videoRef}
            className="w-[750px] h-[1040px] object-cover"
            style={{
